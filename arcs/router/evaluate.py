...
DEFAULT_MODEL_DIR = str(config.ROUTER_MODEL_DIR)
DEFAULT_TEST_CSV = str(config.ROUTER_DATA_DIR / "router_test.csv")
DEFAULT_TRAIN_CSV = str(config.ROUTER_DATA_DIR / "router_train.csv")
DEFAULT_OUTPUT_DIR = str(config.EVAL_RESULTS_DIR)
MAX_LENGTH = 128
BATCH_SIZE = 32
